  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive counseling platform with secure authentication, payment integration using Razorpay, and content management dashboard. Built RESTful APIs for user access control and content management.",
    ...
    },
    {
      title: "InternHub",
      description:
        "Comprehensive intern management system with attendance tracking, performance reports, and feedback handling. Features secure APIs for department-wise intern tracking and data management.",
      techStack: ["MERN Stack", "Cloudinary", "JWT", "OAuth 2.0"],
      image:
        "https://careeremployer.com/wp-content/uploads/2021/11/Project-Management-intern.jpg",
      githubLink:
        "https://github.com/prathameshkhandare/iisppr-backend/tree/Production-Deployment",
      featured: true,
    },
    {
      title: "Skillora",
      description:
        "AI-driven personalized learning platform with test-based performance tracking, personalized content curation, and educator publishing system. Implemented hierarchical filtering using YouTube Data API.",
      techStack: ["MERN Stack", "Generative AI", "JWT", "YouTube API"],
      image:
        "https://miro.medium.com/v2/resize:fit:768/1*PNCNFxT0gMYR0u5uO1u1fQ.png",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Real-world projects showcasing full-stack development and
